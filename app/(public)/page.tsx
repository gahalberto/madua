    ...
    <div className="bg-[#050505] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        >
          <motion.h1
            variants={fadeUp}
            className="font-serif text-6xl md:text-8xl lg:text-9xl text-[#F5F5F5] mb-8 leading-tight tracking-tight"
          >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href="/register"
              className="group px-10 py-5 bg-[#D4AF37] text-black font-bold text-lg rounded-lg hover:bg-[#C4A037] transition-all shadow-2xl shadow-[#D4AF37]/50 hover:shadow-[#D4AF37]/70 hover:scale-105"
            >
              JUNTE-SE À RESISTÊNCIA
            </Link>
            <Link
              href="/sobre"
              className="px-10 py-5 bg-transparent border-2 border-[#D4AF37] text-[#D4AF37] font-bold text-lg rounded-lg hover:bg-[#D4AF37]/10 transition-all"
            >
              LER O MANIFESTO
            </Link>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <h2 className="font-serif text-5xl md:text-7xl text-[#F5F5F5] mb-8 leading-tight">
      ...
      <section className="py-32 relative bg-gradient-to-b from-[#050505] via-zinc-950 to-[#050505]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            <h2 className="font-serif text-5xl md:text-7xl text-[#F5F5F5] mb-6">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="group relative bg-zinc-900 border border-zinc-800 rounded-2xl p-10 hover:border-[#D4AF37]/50 transition-all duration-500 overflow-hidden"
            >
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="relative group bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-[#D4AF37]/50 transition-all min-h-[180px]"
            >
              <div className="p-8">
            ...
            <motion.div
              variants={fadeUp}
              className="lg:col-span-2 relative group bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-[#D4AF37]/50 transition-all min-h-[180px]"
            >
              <div className="p-8">
      ...
      <section className="py-40 relative bg-black">
        ...
        >
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-3 px-12 py-6 bg-[#D4AF37] text-black font-black text-xl uppercase tracking-wider rounded-lg hover:bg-[#C4A037] transition-all shadow-2xl shadow-[#D4AF37]/50 hover:shadow-[#D4AF37]/70 hover:scale-105"
          >
